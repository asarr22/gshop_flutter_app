...
class FlashSaleItemSection extends ConsumerWidget {
  const FlashSaleItemSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final popularProduct = ref.watch(productControllerProvider)['promoCode'];
